...
$ git fetch stable linux-5.3.y
$ git checkout -b linux-5.3.y master
$ git merge --no-stat --allow-unrelated-histories -X ours stable/linux-5.3.y -m "Merge linux-5.3.y"
$ ./config
$ ./build
